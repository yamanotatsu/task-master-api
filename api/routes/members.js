	...
	try {
		...
		return res.status(400).json({
			...
			error: {
				...
				message:
					'This endpoint is deprecated. Please use /api/v1/organizations/:organizationId/members instead'
			}
		});
	...
	try {
		...
		return res.status(400).json({
			...
			error: {
				code: 'DEPRECATED_ENDPOINT',
				message:
					'This endpoint is deprecated. Please use /api/v1/organizations/:organizationId/invites to invite members'
			}
		});
	...
	try {
		...
		return res.status(400).json({
			...
			error: {
				code: 'DEPRECATED_ENDPOINT',
				message:
					'This endpoint is deprecated. Please use /api/v1/organizations/:organizationId/members/:profileId instead'
			}
		});
