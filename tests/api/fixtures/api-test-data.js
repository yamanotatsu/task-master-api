...
export const mockTasks = [
  {
    ...
    description: 'Initial project setup with directory structure and configuration files',
    status: 'completed',
    priority: 'high',
    dependencies: [],
    subtasks: [
  ...
  },
  {
    ...
    reasoning: 'Critical security feature required before other user-specific features',
...
export const mockGeneratedTasks = [
  {
    ...
    description: 'Initialize Node.js project with Express and required dependencies',
    priority: 'high',
...
export const mockSubtasks = [
  ...
  { title: 'Configure environment variables', reasoning: 'Security and flexibility' },
  { title: 'Add middleware configuration', reasoning: 'Request processing pipeline' },
  { title: 'Create basic health check endpoint', reasoning: 'Monitoring capability' }
];
...
export const testScenarios = {
  emptyProject: {
    tasks: [],
    project: { ...mockProject, metadata: { ...mockProject.metadata, taskCount: 0 } }
  },
  singleTask: {
    tasks: [mockTasks[0]],
    project: { ...mockProject, metadata: { ...mockProject.metadata, taskCount: 1 } }
  },
  complexDependencies: {
    tasks: mockTasks,
    project: mockProject
