...
import { Building2, Users, FolderOpen, AlertTriangle, Save } from "lucide-react"
    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{organization.projectCount || 0}</div>
            <p className="text-xs text-muted-foreground">
              進行中のプロジェクト
            </p>
          </CardContent>
          ...
          <div className="space-y-4 py-4">
            <div className="rounded-lg bg-red-50 p-4">
              <p className="text-sm text-red-800">
                <strong>警告:</strong> この操作により以下のデータが削除されます：
              </p>
            ...
            <div className="space-y-2">
              <Label>
                確認のため組織名「<strong>{organization.name}</strong>」を入力してください
              </Label>
              <Input
