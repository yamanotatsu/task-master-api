...
const renderInviteMemberModal = (props = {}) => {
	return render(
		...
		>
			<InviteMemberModal isOpen={true} onClose={mockOnClose} {...props} />
		</MockAuthProvider>
	);
};
...
describe('InviteMemberModal', () => {
	...
	it('shows role descriptions', () => {
		...
		expect(
			screen.getByText(/can view and manage all projects/i)
		).toBeInTheDocument();
		expect(
			screen.getByText(/can view and edit assigned projects/i)
		).toBeInTheDocument();
	});
	...
	it('disables form when member limit reached', () => {
		...
		expect(submitButton).toBeDisabled();
		expect(
			screen.getByText(/upgrade your plan to invite more members/i)
		).toBeInTheDocument();
	});
