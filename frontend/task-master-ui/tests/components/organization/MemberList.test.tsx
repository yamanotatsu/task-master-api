...
describe('MemberList', () => {
  ...
  it('prevents admin from changing their own role', () => {
    ...
    const adminRoleButton = screen.getAllByRole('button', { name: /change role/i })[0]
  ...
  it('shows limited options for non-admin users', () => {
    ...
    const roleButtons = screen.queryAllByRole('button', { name: /change role/i })
    const memberMenus = screen.queryAllByRole('button', { name: /member options/i })
