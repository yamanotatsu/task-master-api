...
describe('Settings Pages', () => {
  ...
  describe('Settings Page', () => {
    ...
    it('redirects unauthenticated users', () => {
      ...
      expect(mockReplace).toHaveBeenCalledWith('/auth/login?redirect=/settings')
    })
    ...
    it('shows email change section with verification', () => {
      ...
      expect(screen.getByText(/current email will remain active/i)).toBeInTheDocument()
    })
    ...
    it('shows timezone settings', () => {
      ...
      expect(screen.getByRole('combobox', { name: /select timezone/i })).toBeInTheDocument()
    })
  ...
  describe('Members Settings Page', () => {
    ...
    it('shows remove member option', async () => {
      ...
      const memberMenus = screen.getAllByRole('button', { name: /member options/i })
    ...
    it('prevents admin from removing themselves', () => {
      ...
      const adminMemberMenu = screen.getAllByRole('button', { name: /member options/i })[0]
    ...
    it('disables invite when member limit reached', () => {
      ...
      const inviteButton = screen.getByRole('button', { name: /member limit reached/i })
