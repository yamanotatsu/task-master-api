...
describe('Signup Page', () => {
  ...
  it('redirects to login page after email confirmation', async () => {
    ...
    expect(loginLink).toHaveAttribute('href', '/auth/login?message=signup_success')
  })
  ...
  it('shows marketing consent checkbox', () => {
    ...
    expect(screen.getByLabelText(/send me product updates/i)).toBeInTheDocument()
  })
  ...
  it('shows password requirements', () => {
    ...
    expect(screen.getByText(/include uppercase and lowercase/i)).toBeInTheDocument()
