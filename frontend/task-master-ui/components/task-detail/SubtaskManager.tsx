...
export const SubtaskManager: React.FC<SubtaskManagerProps> = ({
  ...
  const completedCount = subtasks.filter(s => s.completed || s.status === 'completed').length
      ...
      {subtasks.length > 0 && (
        <div className="mb-3">
          <div className="flex justify-between text-xs text-gray-600 mb-1">
            <span>{completedCount}/{subtasks.length} 完了</span>
            ...
            >
              ...
              {isEditing ? (
                <Input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && handleEditSave(subtask.id)}
